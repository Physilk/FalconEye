...
public:
    ...
    LUA_BEGIN_BIND_METHODS(Orbiter)
        LUA_BIND_CONSTRUCTOR(Point, float)
        LUA_BIND_METHOD_OVERLOAD(Orbiter, lookat, lookat, void, const Point&, const float)
        LUA_BIND_METHOD_OVERLOAD(Orbiter, lookatMinMax, lookat, void, const Point&, const Point&)
        LUA_BIND_METHOD(Orbiter, rotation)
        LUA_BIND_METHOD(Orbiter, translation)
        LUA_BIND_METHOD(Orbiter, move)
